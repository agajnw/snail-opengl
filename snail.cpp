...
double angle=45,shift=0,zoom=-40;
bool mouseLeftDown, mouseMiddleDown, mouseRightDown;
float cameraAngleX=20, cameraAngleY=20, mouseX, mouseY, cameraDistance, light=0;
...
void init()
{
	...
	bg_texture[0] = ilutGLLoadImage((wchar_t*)"tekstury/down.jpg");
	bg_texture[1] = ilutGLLoadImage((wchar_t*)"tekstury/sky.jpg");
	bg_texture[2] = ilutGLLoadImage((wchar_t*)"tekstury/side1.jpg");
	bg_texture[3] = ilutGLLoadImage((wchar_t*)"tekstury/side2.jpg");
	bg_texture[4] = ilutGLLoadImage((wchar_t*)"tekstury/side3.jpg");
	bg_texture[5] = ilutGLLoadImage((wchar_t*)"tekstury/side4.jpg");

	textures[0] = ilutGLLoadImage((wchar_t*)"tekstury/wood.jpg");
	textures[1] = ilutGLLoadImage((wchar_t*)"tekstury/snail.jpg");
	textures[2] = ilutGLLoadImage((wchar_t*)"tekstury/buckHead.jpg");
	textures[3] = ilutGLLoadImage((wchar_t*)"tekstury/bodyFront.jpg");
	textures[4] = ilutGLLoadImage((wchar_t*)"tekstury/wing.jpg");
...
void Keyboard( int key, int x, int y )
{
        switch(key)
        {
				case GLUT_KEY_DOWN: light-=0.1; break;
				case GLUT_KEY_UP: light+=0.1; break;
...
void display()
{
	...
	if (frame_no<500) frame_no++; else frame_no=0;
